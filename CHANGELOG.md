...
## [0.2.3-alpha] - 2025-11-15

### Changed
- **Default behavior changed**: `missing_mask` now defaults to `pass_through`
  - Preserves original node behavior by default
  - Users must explicitly opt-in to auto-generation modes
- Reordered options: pass_through first, then all_visible, all_hidden, error
